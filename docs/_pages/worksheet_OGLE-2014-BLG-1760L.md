---
title: "Worksheet for OGLE-2014-BLG-1760L"
permalink: /teaching/worksheet-OGLE-2014-BLG-1760L/
layout: single
toc: true
...
The lightcurve of event OGLE-2014-BLG-1760 exhibits a strong anomaly caused by the 
presence of a Jupiter mass ratio planet. The source star of this event was unusually blue.   
Most microlensing source stars are in the Galactic bulge or disk on the Sun-ward side 
of the Milky Way, but bright source stars can sometimes be detected from the other
side of the Galaxy.  Analysis by [Bhattacharya et al. 2016 AJ 152, 140](http://adsabs.harvard.edu/abs/2016AJ....152..140B) 
indicated a high relative proper motion between lens and source, raising the 
possibility that subsequent high resolution could distinguish them, once the
object have move apart. 
...
<figure>
  <img src="{{ '/assets/images/OGLE-2014-BLG-1760L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of OGLE-2014-BLG-1760L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of OGLE-2014-BLG-1760L [Bhattacharya et al.(2016)]</figcaption>
</figure>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "6905.856 &plusmn; 0.026"
 document.getElementById("1.4").innerHTML = "0.1806 &plusmn; 0.0074"
 document.getElementById("1.7").innerHTML = "15.87 &plusmn; 0.41"
}
</script>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "0.8269 &plusmn; 0.0047"}
</script>
...
document.getElementById("3.2").innerHTML = "(8.64 &plusmn; 0.89) x10<sup>-4</sup>"
}
</script>
