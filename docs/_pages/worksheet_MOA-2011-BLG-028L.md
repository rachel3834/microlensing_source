---
title: "Worksheet for MOA-2011-BLG-028L"
permalink: /teaching/worksheet-MOA-2011-BLG-028L/
layout: single
toc: true
...
When a microlensing event happens to occur in a region monitored by multiple surveys, it is 
often detected by more than one.  When this happens, the convention is that the names applied 
by each survey are concatenated in the order in which they announced the discovery.  This event 
is properly named "MOA-2011-BLG-028/OGLE-2011-BLG-0203", as it was discovered independently by the 
MOA and OGLE surveys.  
You can read a full account of this event in [Skowron, J. et al. (2016), ApJ, 820, id.4](http://adsabs.harvard.edu/abs/2016ApJ...820....4S).
...
<figure>
  <img src="{{ '/assets/images/MOA-2011-BLG-028L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of MOA-2011-BLG-028L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of MOA-2011-BLG-028L [Skowron et al.(2016)]</figcaption>
</figure>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "5673.788 &plusmn; 0.084"
 document.getElementById("1.4").innerHTML = "0.905 +0.019, -0.029"
 document.getElementById("1.7").innerHTML = "34.26 &plusmn; 0.67"
}
</script>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "1.694 &plusmn; 0.032"}
</script>
...
document.getElementById("3.2").innerHTML = "(0.125 &plusmn; 0.023) <sup>-3</sup>"
}
</script>
