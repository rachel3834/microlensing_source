---
title: "Worksheet for MOA-2010-BLG-328L"
permalink: /teaching/worksheet-MOA-2010-BLG-328L/
layout: single
toc: true
...
The first discovery alert for MOA-2010-BLG-328 was issued from the MOA survey on 
2010 June 16.  Around 39 days later, the MOA observer first noticed a few anomalous 
datapoints, which were confirmed by subsequent observations.  They then issued an anomaly 
alert to the community, who responded by obtaining high cadence follow-up data. 
The analysis of the event is described in [Furusawa et al. 2013 ApJ 779, 91](http://adsabs.harvard.edu/cgi-bin/nph-bib_query?bibcode=2013ApJ...779...91F).
...
<figure>
  <img src="{{ '/assets/images/MOA-2010-BLG-328L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of MOA-2010-BLG-328L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of MOA-2010-BLG-328L [Furusawa et al.(2013)]</figcaption>
</figure>
...
<tr>
 <td>Change in magnitude = &#916;m:</td><td> <input type="text"></td><td id="1.2"></td>
</tr>
<tr>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "5378.638 &plusmn; 0.014"
 document.getElementById("1.4").innerHTML = "0.0721 &plusmn; 0.0008"
 document.getElementById("1.7").innerHTML = "62.6 &plusmn; 0.6"
}
</script>
...
<tr>
 <td>Source-lens separation = u = &#8730;(u<sub>0</sub><sup>2</sup> + &#964;<sup>2</sup>) :</td><td> <input type="text"></td><td id="2.3"></td>
</tr>
<tr>
 <td>y<sub>&#177;</sub> = &#177; (&frac12;) (&#8730;(u<sup>2</sup> + 4) &#177; u) :</td><td> <input type="text"></td><td id="2.4"></td>
</tr>
<tr>
 <td>Is the perturbation a major image (+) or minor image (-) perturbation?</td><td> <input type="text"></td><td id="2.5"></td>
</tr>
<tr>
<td>Location of the planet = s :</td><td> <input type="text"></td><td id="2.6"></td>
</tr>
</table>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "1.154 &plusmn; 0.016"}
</script>
...
document.getElementById("3.2").innerHTML = "(2.60 &plusmn; 0.53) x10<sup>-4</sup>"
}
</script>
...
<script>
document.getElementById("hint5Btn").addEventListener("click", show_hint5_content)
function show_hint5_content() {
...
var cell4 = document.getElementById("4.1")
cell4.textContent = "Neptune (see "
var ref4 = document.createElement("a")
ref4.href = "http://adsabs.harvard.edu/cgi-bin/nph-bib_query?bibcode=2013ApJ...779...91F"
ref4.target = "_blank"
ref4.rel = "noopener"
ref4.textContent = "paper"
cell4.appendChild(ref4)
