---
title: "Worksheet for OGLE-2012-BLG-358L"
permalink: /teaching/worksheet-OGLE-2012-BLG-358L/
layout: single
toc: true
...
Microlensing has uncovered a wide range of planetary systems, and thrown up 
several surprises.  OGLE-2012-BLG-358L is one such event - analysis by 
[Han et al. 2013 ApJ 778, 38](http://adsabs.harvard.edu/abs/2013ApJ...778...38H) 
showed that the event was caused by a planet orbiting a brown dwarf.  
...
<figure>
  <img src="{{ '/assets/images/OGLE-2012-BLG-358L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of OGLE-2012-BLG-358L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of OGLE-2012-BLG-358L [Han et al.(2013)]</figcaption>
</figure>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "6057.49 &plusmn; 0.10"
 document.getElementById("1.4").innerHTML = "0.832 &plusmn; 0.002"
 document.getElementById("1.7").innerHTML = "25.64 &plusmn; 0.08"
}
</script>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "1.700 &plusmn; 0.002"}
</script>
...
document.getElementById("3.2").innerHTML = "(12.281 &plusmn; 0.118) x10<sup>-2</sup>"
}
</script>
