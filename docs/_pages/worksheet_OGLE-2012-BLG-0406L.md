---
title: "Worksheet for OGLE-2012-BLG-0406L"
permalink: /teaching/worksheet-OGLE-2012-BLG-0406L/
layout: single
toc: true
...
When theories of planetary formation predicted that massive planets should only 
form close-in to their host stars, microlensing once again delivered a 
challenge.  Event OGLE-2012-BLG-0406L revealed a 3.9 $$M_{Jupiter}$$-mass planet
orbiting a late-type star with an orbital separation of at least 3.9 AU.  This places
the planet beyond the snowline of its star.  This event is discussed in 
[Poleski et al. 2014 ApJ 782, 47](http://adsabs.harvard.edu/abs/2014ApJ...782...47P), and 
[Tsapras et al. 2014 ApJ 782, 48](http://adsabs.harvard.edu/abs/2014ApJ...782...48T).  
...
<figure>
  <img src="{{ '/assets/images/OGLE-2012-BLG-406L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of OGLE-2012-BLG-406L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of OGLE-2012-BLG-406L [Poleski et al.(2014)]</figcaption>
</figure>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "6141.33 &plusmn; 0.05"
 document.getElementById("1.4").innerHTML = "0.496 &plusmn; 0.002"
 document.getElementById("1.7").innerHTML = "64.77 &plusmn; 0.19"
}
</script>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "1.301 &plusmn; 0.002"}
</script>
...
document.getElementById("3.2").innerHTML = "(5.92 &plusmn; 0.11) x10<sup>-3</sup>"
}
</script>
