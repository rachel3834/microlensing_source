---
title: "Binary Lens Simulator"
permalink: /resources/binary-lens-simulator/
layout: single
classes: wide
---
...
<div class="row" style="text-align:center; position:relative; padding: 5px 10px; justify-content:center;">
  ...
  <div><input type="checkbox" id="displayRingsCheckbox" checked>Display independent Einstein rings</div>
  <div><input type="checkbox" id="displayCritCheckbox" checked>Display critical curves</div>
  <div><input type="checkbox" id="displayCausticCheckbox" checked>Display caustic curves</div>
</div>
    ...
    <tr>
      <td valign="top" style="width:450px; background-color:#f4f7f8;padding:10px"><h3>Event Parameters</h3>
        ...
        <table style="width:100%;">
          ...
          <tr>
            <td>Incline</td>
            <td style="width:60%;"><input type="range" id="inclineSlider" min="-89.99" max="89.99" step="0.01" value="2.0" style="width:100%;">
            <span id="inclineReadout" style="display:inline-block; width:2.6em; text-align:right;">8.00</span> degrees</td>
          </tr>
        </table>
      </td>
      ...
      <td valign="top" style="width:450px; background-color:#f4f7f8;padding:10px"><h3>Physical Parameters</h3>
        <table style="width:100%;">
          <tr>
            ...
            <td style="width:60%;"><input type="range" id="Ml1slider" min="0.000001" max="15" step="0.000001" value="0.1" style="width:100%;">
            <span id="Ml1readout" style="display:inline-block; width:4.8em; text-align:right;">0.100000</span> M<sub>&#9737;</sub></td>
          </tr>
          <tr>
            <td>Lens mass 2, M<sub>l,2</sub></td>
            <td style="width:60%;"><input type="range" id="Ml2slider" min="0.000001" max="15" step="0.000001" value="0.1" style="width:100%;">
            <span id="Ml2readout" style="display:inline-block; width:4.8em; text-align:right;">0.100000</span> M<sub>&#9737;</sub></td>
          </tr>
          <tr>
            <td>Lens angular separation</td>
            <td style="width:60%;"><input type="range" id="lensSepSlider" min="0.001" max="5.0" step="0.001" value="0.012" style="width:100%;">
            <span id="lensSepReadout" style="display:inline-block; width:2.6em; text-align:right;">0.012</span> mas</td>
          </tr>
          <tr>
          ...
          <tr valign="bottom">
            <td valign="bottom"><input type="button" id="resetParams" value="Reset Parameters"></td>
          </tr>
        </table>
      </td>
    </tr>
...
<script src="{{ '/assets/js/PSBL_bundle.js' | relative_url }}"></script>
