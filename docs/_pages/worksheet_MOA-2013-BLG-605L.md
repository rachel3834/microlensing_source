---
title: "Worksheet for MOA-2013-BLG-605L"
permalink: /teaching/worksheet-MOA-2013-BLG-605L/
layout: single
toc: true
...
Models of microlensing events have quite a number of parameters which makes for a complex parameter 
space. In addition there are several degeneracies, meaning that models with different parameters 
can create a very similar lightcurves.  For some events this can make it difficult to 
conclusively infer the nature of the lensing system.  Follow-up observations like high-resolution 
imaging can help to detect or place constraints on the flux from the lens, which can be decisive 
in determining the mass of the lensing system.  MOA-2013-BLG-605L is a good example of such a case. 
See [Sumi et al. 2016 ApJ 825, 112](http://adsabs.harvard.edu/abs/2015arXiv151200134S) for a full 
description. 
...
<figure>
  <img src="{{ '/assets/images/MOA-2013-BLG-605L_Lightcurve.jpg' | relative_url }}" alt="Lightcurve of MOA-2013-BLG-605L" style="max-width:600px; width:100%;">
  <figcaption>Lightcurve of MOA-2013-BLG-605L [Sumi et al.(2016)]</figcaption>
</figure>
...
function show_ex1a_answers() {
 ...
 document.getElementById("1.1").innerHTML = "6573.055 &plusmn; 0.009"
 document.getElementById("1.4").innerHTML = "(8.042 &plusmn; 0.162) x10<sup>-2</sup>"
 document.getElementById("1.7").innerHTML = "19.70 &plusmn; 0.25"
}
</script>
...
function show_2_answers() {
 ...
 document.getElementById("2.6").innerHTML = "2.349 &plusmn; 0.016"}
</script>
...
<tr>
 <td>Planet Einstein Timescale = t<sub>p,E</sub> ~ t<sub>FWHM</sub> :</td><td> <input type="text"></td><td id="3.1"></td></tr>
...
document.getElementById("3.2").innerHTML = "(3.137 &plusmn; 0.082) x10<sup>-4</sup>)"
}
</script>
